...
[pimoroni-plasma-2040]: https://github.com/rp-rs/pimoroni-plasma-2040
...
```console
pimoroni-plasma-2040 $ cargo build --release --example <name>
```
...
```console
pimoroni-plasma-2040 $ cargo run --release --example <name>
```
...
6. Create a [New Pull Request](https://github.com/rp-rs/pimoroni-plasma-2040/pulls)
